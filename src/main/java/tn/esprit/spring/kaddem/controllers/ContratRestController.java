...
public class ContratRestController {
	...
	public Contrat addContrat(@RequestBody ContratDTO dto) {
		Contrat contrat = new Contrat();
		contrat.setDateDebutContrat(dto.getDateDebutContrat());
		contrat.setDateFinContrat(dto.getDateFinContrat());
		contrat.setSpecialite(dto.getSpecialite());
		contrat.setArchive(dto.getArchive());
		contrat.setMontantContrat(dto.getMontantContrat());
	...
	public Contrat updateContrat(@RequestBody ContratDTO dto) {
		Contrat contrat = new Contrat();
